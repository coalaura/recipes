...
public class RecipeDefinitions {
	...
	private void registerMetalRecycling() {
		...
		Object[][] metalRecycling = {
			...
			// Copper Door
			{Material.COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.EXPOSED_COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.WEATHERED_COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.OXIDIZED_COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.WAXED_COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.WAXED_EXPOSED_COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.WAXED_WEATHERED_COPPER_DOOR, Material.COPPER_INGOT, 9},
            {Material.WAXED_OXIDIZED_COPPER_DOOR, Material.COPPER_INGOT, 9},

			// Copper Trapdoor
			{Material.COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.EXPOSED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.WEATHERED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.OXIDIZED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.WAXED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.WAXED_EXPOSED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.WAXED_WEATHERED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
            {Material.WAXED_OXIDIZED_COPPER_TRAPDOOR, Material.COPPER_INGOT, 13},
