...
A lightweight Paper 1.21.10 plugin that expands the vanilla crafting system with balanced recycling and Quality of Life (QoL) recipes. The goal is to allow players to reclaim materials and simplify certain tasks without breaking the vanilla feel of the game.
...
### Block Uncrafting
* **Crafting Grid:** Break down assembled blocks (Quartz, Clay, Amethyst, Glowstone, Magma, Honeycomb, Snow, Bricks, Melon, Nether Wart) back into their base materials.
* **Melting:** Smelt Blue Ice into Packed Ice and Packed Ice into regular Ice.

### Washing & Bleaching
* Clean dyed items (Wool, Carpets, Glass, Beds, Terracotta, Concrete) back to their default white or uncolored states using a Water Bucket. 
* Works for single items (1 item + 1 bucket) or bulk washing (8 items + 1 bucket).
